...
const { createBooking, getBookingsByUserId } = require('../controllers/consultationController');
...
router.post('/createBooking', requireSignIn, createBooking);
router.get('/getBooking', requireSignIn, getBookingsByUserId);
